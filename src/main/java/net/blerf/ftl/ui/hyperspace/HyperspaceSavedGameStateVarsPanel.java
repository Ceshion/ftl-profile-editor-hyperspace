...
public class HyperspaceSavedGameStateVarsPanel extends JPanel {

	private static final Logger log = LoggerFactory.getLogger( HyperspaceSavedGameStateVarsPanel.class );
	...
	public HyperspaceSavedGameStateVarsPanel( HyperspaceFrame frame ) {
