...
public class HyperspaceSavedGameSectorTreePanel extends JPanel implements ActionListener {

	private static final Logger log = LoggerFactory.getLogger( HyperspaceSavedGameSectorTreePanel.class );
	...
	public HyperspaceSavedGameSectorTreePanel( HyperspaceFrame frame ) {
