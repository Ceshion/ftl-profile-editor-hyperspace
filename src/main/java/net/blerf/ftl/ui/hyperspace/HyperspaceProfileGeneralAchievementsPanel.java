...
import net.blerf.ftl.ui.FieldEditorPanel.ContentType;
import net.blerf.ftl.ui.hyperspace.HyperspaceFrame;
import net.blerf.ftl.xml.Achievement;


public class HyperspaceProfileGeneralAchievementsPanel extends JPanel {

	private static final Logger log = LoggerFactory.getLogger( HyperspaceProfileGeneralAchievementsPanel.class );
	...
	public HyperspaceProfileGeneralAchievementsPanel( HyperspaceFrame frame ) {
