...
public class HyperspaceSavedGameFloorplanPanel extends JPanel {

	private static final Logger log = LoggerFactory.getLogger( HyperspaceSavedGameFloorplanPanel.class );
	...
	public HyperspaceSavedGameFloorplanPanel( HyperspaceFrame frame ) {
			...
			public boolean spriteSelected( SpriteSelector spriteSelector, JComponent sprite ) {
				if ( sprite instanceof DoorSprite ) {
					...
					if ( ftlConstants instanceof AdvancedFTLConstants ) {  // TODO: Remove this.
						JOptionPane.showMessageDialog( HyperspaceSavedGameFloorplanPanel.this.frame, "Drone editing is not possible yet for Advanced Edition saved games.\n\nHowever, cargo (General tab) and stores (Sector Map tab) can be edited.", "Work in Progress", JOptionPane.WARNING_MESSAGE );
					}
					else {
					...
					if ( ftlConstants instanceof AdvancedFTLConstants ) {  // TODO: Remove this.
						JOptionPane.showMessageDialog( HyperspaceSavedGameFloorplanPanel.this.frame, "Weapon editing is not possible yet for Advanced Edition saved games.\n\nHowever, cargo (General tab) and stores (Sector Map tab) can be edited.", "Work in Progress", JOptionPane.WARNING_MESSAGE );
					}
					else {
