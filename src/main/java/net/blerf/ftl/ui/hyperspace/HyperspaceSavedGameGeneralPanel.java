...
public class HyperspaceSavedGameGeneralPanel extends JPanel {

	private static final Logger log = LoggerFactory.getLogger( HyperspaceSavedGameGeneralPanel.class );
	...
	public HyperspaceSavedGameGeneralPanel( HyperspaceFrame frame ) {
