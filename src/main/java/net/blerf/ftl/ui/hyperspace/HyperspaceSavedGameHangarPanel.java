...
public class HyperspaceSavedGameHangarPanel extends JPanel {

	private static final Logger log = LoggerFactory.getLogger( HyperspaceSavedGameHangarPanel.class );
	...
	public HyperspaceSavedGameHangarPanel( HyperspaceFrame frame ) {
